...
TcpSocketBase::ReceivedAck (Ptr<Packet> packet, const TcpHeader& tcpHeader)
{
  ...
  /***************************************************/
  //** DCTCP: If last time it was ECE but this time it was not, reset...
  ...
  if (m_tcb->m_ecnState == TcpSocketState::ECN_ECE_RCVD && m_ecnEchoSeq.Get() > m_ecnCWRSeq.Get () && !isRetransmission)
    {
      ...
      /***************************************************/
      //** DCTCP: In DCTCP you do not enter CWR state, you just continue as normal...
      if (m_congestionControl->GetName() != "TcpDctcp" && m_tcb->m_congState == TcpSocketState::CA_OPEN)
        {
